document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadProducts() {
        // Use relative path directly - let the browser handle the context
        const apiPath = "products";

        console.log("Loading products from:", apiPath);
        ...
        fetch(apiPath)
            .then(res => {
                ...
                return res.text().then(text => {
                    try {
                        ...
                        console.error("Received invalid JSON (loadProducts):", text);
            ...
            .then(products => {
                ...
                if (tbody) {
                    ...
                    if (products.length === 0) {
                        tbody.innerHTML = "<tr><td colspan='4' style='text-align: center;'>No products yet. Add your first product!</td></tr>";
                    } else {
                        products.forEach(p => {
                            tbody.innerHTML += `
                            <tr>
            ...
            .catch(err => {
                ...
                const tbody = document.getElementById("product-table-body");
                if (tbody) {
                    tbody.innerHTML = "<tr><td colspan='4' style='text-align: center; color: red;'>Error loading products</td></tr>";
                }
            });
    }
